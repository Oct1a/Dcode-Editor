module.exports = app => ({
  ...
  async create(pageData) {
    ...
    return await $model.page.create({
      ...
      shareConfig: pageData.shareConfig,
      pages: pageData.pages,
      script: pageData.script,
      author: userData._id,
      width: pageData.width,
      height: pageData.height,
      pageMode: pageData.pageMode,
      flipType: pageData.flipType,
      slideNumber: pageData.slideNumber,
      add_time: pageData.add_time,
      up_time: pageData.up_time,
      status: pageData.status,
      isPublish: pageData.isPublish,
      isTemplate: pageData.isTemplate,
