  ...
  bind(el) {
    ...
    dialogHeaderEl.onmousedown = (e) => {
      ...
      document.onmousemove = (e) => {
        ...
        // if (dialogHeaderEl.getBoundingClientRect().left < 10) return dragDom.style.left = `${styL}px`;

        if (e.clientY <= 15) return false;
        if ((document.body.offsetHeight - (e.clientY + parseInt(sty.height.replace('px', '')))) <= 30) return false;
