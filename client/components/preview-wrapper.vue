  ...
  <div class="components-preview">
    ...
    <div class="left-panel">
      <div class="iframe-wrapper" :style="{width: $config.canvasH5Width + 'px', height: $config.canvasH5Height + 'px'}">
        <iframe :src="$config.baseURL + '/view/' + pageId" frameborder="0" style="background-color:transparent;width: 100%; height: 100%;"></iframe>
      </div>
    </div>
...
<style lang="scss" scoped>
  ...
  .left-panel {
    ...
    z-index: 1050;
    overflow: hidden;
    // background: url(../common/images/phoneModel.png) no-repeat 45%;
  }
  .right-panel{
    position: fixed;
    width: 640px;
